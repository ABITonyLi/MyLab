...
WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/SignatureBoard/span_basicinfo'))

WebUI.waitForPageLoad(20)

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/SignatureBoard/span_contractfile'))

WebUI.waitForPageLoad(20)

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/SignatureBoard/span_otherfiles'))

WebUI.waitForPageLoad(20)

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/SignatureBoard/span_withcontract'))

WebUI.waitForPageLoad(20)

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/SignatureBoard/span_approverecord'))

WebUI.waitForPageLoad(20)

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/SignatureBoard/span_ordernext'))

WebUI.waitForPageLoad(20)

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/SignatureBoard/span_excutiondetail'))

WebUI.waitForPageLoad(20)

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/SignatureBoard/span_timeline'))

WebUI.waitForPageLoad(20)

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/SignatureBoard/span_DAG'))

WebUI.waitForPageLoad(20)

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/SignatureBoard/btn_viewapprovesteps'))
...
WebUI.verifyElementNotPresent(findTestObject('Object Repository/Page_ABI One Process Center/SignatureBoard/a_contract_autotest1'), 
    5)
