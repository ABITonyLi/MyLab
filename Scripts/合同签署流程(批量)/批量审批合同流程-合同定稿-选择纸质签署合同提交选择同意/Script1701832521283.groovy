...
var1 = WebUI.getText(findTestObject('Page_ABI One Process Center/NeedToDoTask/BatchDG_page/span_applycontent_row1'))
var1 = var1.split('-')[0]
//var2 = WebUI.getText(findTestObject('Page_ABI One Process Center/NeedToDoTask/BatchDG_page/span_applycontent_row2'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/BatchDG_page/select_sginprocess'), 
    '纸质签署', true)

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/BatchDG_page/btn_sginprocessapplyallcontract'))

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/BatchDG_page/btn_sginprocessapplyallcontract_confirm'))
...
for(int i=0;i<2;i++) {
	...
	WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/a_contractapplycontent_link_'+(i+1).toString()))
	
	WebUI.switchToWindowTitle('合同签署流程')
	
	WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Contractsignprocess_page/btn_submitorreject'))
	
	WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Contractsignprocess_page/radio_returndraftnode'))
	
	WebUI.setText(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Contractsignprocess_page/textarea_returndraftnode_remark'),
		'autotest退回合同起草节点')
	
	WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Contractsignprocess_page/btn_submitorreject_submit'))
	
	WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Contractsignprocess_page/btn_submitorreject_submit_confirm'))
