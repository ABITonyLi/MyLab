...
WebUI.waitForElementClickable(findTestObject('Page_ABI One Process Center/NeedToDoTask/btn_approvecontract-'+(loc+1).toString()), 10)

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/btn_approvecontract-'+(loc+1).toString()))
