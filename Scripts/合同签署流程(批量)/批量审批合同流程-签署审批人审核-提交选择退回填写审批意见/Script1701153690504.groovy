...
/*
var1 = WebUI.getText(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Batchapprove_page/span_contractno_row2'))

var2 = WebUI.getText(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Batchapprove_page/span_contractno_row1'))
...
assert v1 < v2
*/
WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Batchapprove_page/radio_row1_reject'))

WebUI.setText(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Batchapprove_page/input_rejectcontent_row1'), 
    'autotest_签署审批人选择退回')

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Batchapprove_page/btn_applyapproveallcontract'))

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Batchapprove_page/btn_applyapproveallcontract_confirm'))

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Batchapprove_page/btn_signapprover_submit'))

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Batchapprove_page/btn_approvesubmit_confirm'))

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Batchapprove_page/btn_signapprover_submit_confirm'))

WebUI.closeBrowser()
'后置处理-经办人取消实例'
WebUI.callTestCase(findTestCase('合同签署流程(批量)/ProcessSteps/经办人取消实例'), ["applycontent":TCcallback.get('contractname'),"contractcount":2], FailureHandling.STOP_ON_FAILURE)
