...
'前置处理-签署审批人通过'
WebUI.callTestCase(findTestCase('合同签署流程(批量)/ProcessSteps/签署审批人通过'), [('applycontent') : TCcallback.get('timestamp'),('count') : '1'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/Batchapprove_page/span_total'), 
    '共计 1 条合同条目，目前已展示 1 条')

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/BatchDG_page/btn_havelegalapproved_dg'),
	10)


WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/BatchDG_page/btn_havelegalapproved_dg'))
...
'合同定稿退回'
WebUI.callTestCase(findTestCase('合同签署流程(批量)/ProcessSteps/合同定稿退回'), [('applycontent') : TCcallback.get('timestamp'), ('count') : '1'], FailureHandling.STOP_ON_FAILURE)
'后置处理-经办人取消实例'
WebUI.callTestCase(findTestCase('合同签署流程(批量)/ProcessSteps/经办人取消实例'), [('applycontent') : '1702623958', ('contractcount') : 1],
