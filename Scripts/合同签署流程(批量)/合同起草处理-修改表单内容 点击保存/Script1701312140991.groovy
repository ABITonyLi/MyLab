...
WebUI.setText(findTestObject('Object Repository/Page_ABI One Process Center/DAGDataPool/ContractBatchSignProcess_Page/input_batchcontractname'), 
    'autotest批量发起起草修改' + currenttimestamp.toString())
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_ABI One Process Center/DAGDataPool/ContractBatchSignProcess_Page/tip_alreadysave'), 
    10)

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/DAGDataPool/ContractBatchSignProcess_Page/btn_alreadysave_confirm'))

WebUI.switchToWindowTitle('ABI One Process Center')

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/NeedToDoTask/btn_contractdraft-1'))

WebUI.switchToWindowTitle('合同签署流程')

WebUI.waitForPageLoad(30)

WebUI.verifyElementAttributeValue(findTestObject('Page_ABI One Process Center/DAGDataPool/ContractBatchSignProcess_Page/input_batchcontractname'), 
    'value', 'autotest批量发起起草修改' + currenttimestamp.toString(), 10)

WebUI.closeBrowser()

'后置处理-经办人取消实例'
WebUI.callTestCase(findTestCase('合同签署流程(批量)/ProcessSteps/经办人取消实例'), [('applycontent') : 'autotest批量发起起草修改' + currenttimestamp.toString()
