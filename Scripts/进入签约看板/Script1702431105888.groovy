...
'合同签署'
WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/span_contractsignature'))

'签约看板'
WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/span__signatureboard'))
