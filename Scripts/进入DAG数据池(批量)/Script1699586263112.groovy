...
'DAG管理'
WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/span_DAGmanagement'))

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/span_DAGdatapool_batch'))
