...
WebUI.verifyElementText(findTestObject('Object Repository/Page_ABI One Process Center/DAGDataPool/tip_contractinfomodify_no'), 
    '该合同条目未发起流程无法修改流程信息')

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/DAGDataPool/btn_contractinfomodify_no_confirm'))
