...
WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/DAGDataPool/tip_DAGinfosupplement_nopermission'))

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/DAGDataPool/btn_DAGinfosupplement_nopermission_confirm'))
