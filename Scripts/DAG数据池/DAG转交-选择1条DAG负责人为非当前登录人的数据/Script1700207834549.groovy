...
WebUI.verifyElementText(findTestObject('Object Repository/Page_ABI One Process Center/DAGDataPool/tip_DAGtransfer_nopermission'), 
    '您没有操作权限')

WebUI.click(findTestObject('Object Repository/Page_ABI One Process Center/DAGDataPool/btn_DAGtransfer_nopermision_confirm'))
